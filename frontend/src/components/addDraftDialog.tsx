...
const AddDraft = ({ ownerId, managerId, data }: AddDraftProps) => {
                ...
                <DialogContent>
                    ...
                    <form onSubmit={onSubmit} className="space-y-4">
                        ...
                        <DialogFooter className="mt-10">
                            ...
                            <Button type="submit" className="disabled:cursor-not-allowed" disabled={loading || progress !== 100}>Save changes</Button>
                        </DialogFooter>
                    </form>
                </DialogContent>
            </Dialog>
